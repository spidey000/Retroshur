...
@echo off & Cls & Color 0E & Title Retroshur Rom Downloader: PCengine (577.8 MB)
SET HOME="%~dp0"
...
SET "LISTA=https://mega.nz/#!3wVmWAIJ!lgvLfC7rwAqH3svLUjGe9WSa3BZfXFkmRZhc45F0wWg"
echo(
echo Creando carpetas temporales
if not exist %TEMPORALES% mkdir %TEMPORALES%
timeout 2 > NUL
echo Hecho!
echo Descargando Backup PCengine para Retroshur
timeout 2 > NUL
%BAJAR% --print-names %LISTA% --path %TEMPORALES%
cd %TEMPORALES%
%EXTRAER% x pcengine.zip -o%CARPETA% -aoa 
cd %TEMPORALES%\..\..
