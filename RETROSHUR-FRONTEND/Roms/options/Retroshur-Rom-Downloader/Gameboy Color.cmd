...
@echo off & Cls & Color 0E & Title Retroshur Rom Downloader: Atari lynx (1.38 GB)
SET HOME="%~dp0"
...
SET "LISTA=https://mega.nz/#!D18RQDpB!IdJIumvFUgmaIjpfYk138hjJeaa-DgfJPo_qMQiK9ds"
echo(
...
cd %TEMPORALES%
%EXTRAER% x gbc.zip -o%CARPETA% -aoa 
cd %TEMPORALES%\..\..
