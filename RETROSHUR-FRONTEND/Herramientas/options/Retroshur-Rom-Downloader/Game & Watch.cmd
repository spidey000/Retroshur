...
@echo off & Cls & Color 0E & Title Retroshur Rom Downloader: Nintendo Game & Watch (60.3 MB)
SET HOME="%~dp0"
...
set "LISTA=https://mega.nz/#!n18BwAbQ!5lJQieb7D8d2z1biU9rFTj_VPF64XPvAiQ1UkJYYZ5U"
echo(
echo Creando carpetas temporales
if not exist %TEMPORALES% mkdir %TEMPORALES%
timeout 2 > NUL
echo Hecho!
echo Descargando Backup Nintendo Game & Watch para Retroshur
timeout 2 > NUL
%BAJAR% --print-names %LISTA% --path %TEMPORALES%
cd %TEMPORALES%
%EXTRAER% x gameandwatch.zip -o%CARPETA% -aoa 
cd %TEMPORALES%\..\..
