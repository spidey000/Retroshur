...
@echo off & Cls & Color 0E & Title Retroshur Rom Downloader: GameGear
SET HOME="%~dp0"
...
SET "LISTA=https://mega.nz/#!DpERQQDY!FKwXsDkEoZ29eA5DhgH54WUTPs6n1rX2gDayVgAUphs"
echo(
echo Creando carpetas temporales
if not exist %TEMPORALES% mkdir %TEMPORALES%
timeout 2 > NUL
echo Hecho!
echo Descargando Backup GameGear para Retroshur
timeout 2 > NUL
%BAJAR% --print-names %LISTA% --path %TEMPORALES%
cd %TEMPORALES%
%EXTRAER% x gamegear.zip -o%CARPETA% -aoa 
cd %TEMPORALES%\..\..
