...
@echo off & Cls & Color 0E & Title Retroshur Rom Downloader: Capcom Play System 3 (475.2 MB)
SET HOME="%~dp0"
...
SET "LISTA=https://mega.nz/#!Lo1AzB6a!p2816P_V_hwSv3Ll503eDxxbzWkiGdLLmjvwSKeMTOY"
echo(
echo Creando carpetas temporales
if not exist %TEMPORALES% mkdir %TEMPORALES%
timeout 2 > NUL
echo Hecho!
echo Descargando Backup Capcom Play System 3 para Retroshur
timeout 2 > NUL
%BAJAR% --print-names %LISTA% --path %TEMPORALES%
cd %TEMPORALES%
%EXTRAER% x cps3.zip -o%CARPETA% -aoa 
cd %TEMPORALES%\..\..
