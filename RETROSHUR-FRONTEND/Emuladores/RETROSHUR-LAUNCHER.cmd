...
::start "Frameless" /d %BCK% "Frameless.exe" %~dp0Backgrounds\mastersystem\launching.jpg
start "autohotkey" /d %AUTOHOTKEY% "AutoHotkeyU64.exe" Mouse.ahk
...
:RETROARCH-MEGADRIVE
::start "Frameless" /d %BCK% "Frameless.exe" %~dp0Backgrounds\megadrive\launching.jpg
start "autohotkey" /d %AUTOHOTKEY% "AutoHotkeyU64.exe" Mouse.ahk
...
start "Frameless" /d %BCK% "Frameless.exe" %~dp0Backgrounds\wonderswan\launching.jpg
start "autohotkey" /d %AUTOHOTKEY% "AutoHotkeyU64.exe" Mouse.ahk
