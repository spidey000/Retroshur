...
; On first launch, FourDO will ask you to point it to the fz10.rom. After you do that, exit the emu and select a game in your Front End and it should work.
...
{	VirtualDrive("mount",romPath . "\" . romName . romExtension)
	Run(executable . " -StartLoadDrive " . vdDriveLetter . " " . fullscreen . " " . useGDI, emuPath)
} Else
