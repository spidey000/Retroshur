...
; If you are launching directly from the main menu wheel, don't forget to set Skip Checks to Rom Only
; Also romExtension and romPath should be empty on this case.
;----------------------------------------------------------------------------
StartModule()
FadeInStart()
...
hideEmuObj := Object("DWJukebox ahk_class AllegroWindow",1)	; Hide_Emu will hide these windows. 0 = will never unhide, 1 = will unhide later
HideEmuStart()
