...
;
; Put the exec.bin,grom.bin and ecs.bin bios files in the same folder as jzintv.exe
;----------------------------------------------------------------------------
StartModule()
BezelGui()
FadeInStart()
...
hideEmuObj := Object("jzintv.exe ahk_class ConsoleWindowClass",0,"jzintv ahk_class SDL_app",1)	; Hide_Emu will hide these windows. 0 = will never unhide, 1 = will unhide later
