...
;----------------------------------------------------------------------------
; Notes:
; This module is for the Hacked version of the emu, NOT the normal release as it will not work. http://www.rlauncher.com/forum/downloads.php?do=file&id=5
; Make sure lynxboot.img is in the dir with the emu.
; 
; Set the variables in RocketLauncherUI to your liking
...
hideEmuObj := Object("ahk_class AfxFrameOrView100sd",1)	; Hide_Emu will hide these windows. 0 = will never unhide, 1 = will unhide later
