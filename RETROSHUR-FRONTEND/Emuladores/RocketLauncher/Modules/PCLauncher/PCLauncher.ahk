...
MSystem = "American Laser Games","Arcade PC","Doujin Soft","Examu eX-BOARD","OpenBor","Games for Windows","Konami e-Amusement","Konami Bemani","Microsoft Windows","PCLauncher","PC Games","Singstar","Steam","Steam Big Picture","Taito Type X","Taito Type X2","Touhou","Touhou Project","Ultrastar","Cave","Windows Games","MUGEN","Daphne"
;----------------------------------------------------------------------------
; Notes:
