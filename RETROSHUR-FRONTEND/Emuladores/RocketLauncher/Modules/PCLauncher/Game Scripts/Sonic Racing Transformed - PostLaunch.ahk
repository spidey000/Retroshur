...
frontendTitle=		; Set your Front End window title here. You can get this by using the AutoIt3 Window Spy Utility
;----------------------------------------------------------------------------------------------------
...
If (noLauncherWindow && noGameWindow) {	; neither window showed up, let's close RocketLauncher because there was a problem loading the game
	Process, Close, RocketLauncher.exe
	MsgBox,,PostLaunch Script, Problem running game or launcherWindow or gameWindow set wrong in this script`, please fix and try again. Closing RocketLauncher.`n`nlauncherWindow: %launcherWindow%`ngameWindow: %gameWindow%,6	; showing msgbox for 6 seconds
