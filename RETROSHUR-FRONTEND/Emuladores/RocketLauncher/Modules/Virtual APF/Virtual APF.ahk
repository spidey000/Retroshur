...
RAMExpansion := IniReadCheck(settingsFile, romName, "RAMExpansion","0",,1)
...
currentRamexpansion := IniReadCheck(emuIni, "MEMORY", "expandertype","0",,1)
...
If RAMExpansion != currentRamexpansion
	IniWrite, %RAMExpansion%, %emuIni%, MEMORY, expandertype
