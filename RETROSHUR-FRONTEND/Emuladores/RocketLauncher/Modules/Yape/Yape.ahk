...
7z(romPath, romName, romExtension, sevenZExtractPath1)

yapeINI := CheckFile(emuPath . "\yape.ini")
currentStartInFullScreen := IniRead(yapeINI, "Yape configuration file", "StartInFullScreen")
currentDoubleSizedWindow := IniRead(yapeINI, "Yape configuration file", "Double sized window")
