...
hideEmuObj := Object("Altirra ahk_class AltirraMainWindow",1)	; Hide_Emu will hide these windows. 0 = will never unhide, 1 = will unhide later
...
RestoreEmu:
	If (Fullscreen = "true")
		WinMenuSelectItem,Altirra ahk_class AltirraMainWindow,,View,Full Screen
Return
