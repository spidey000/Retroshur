...
7z(ByRef _7zP, ByRef _7zN, ByRef _7zE, ByRef _7zExP,call="", AttachRomName=true, AllowLargerFolders=false){
	...
	Global fadeIn,fadeLyr37zAnimation,fadeLyr3Animation,fadeLyr3Type,RLObject,RLLog,sevenZTempRomExists,use7zAnimation,romExSize,sevenZ1stRomPath,sevenZRomPath,sevenZPID,sevenZStatus
...
7zCleanUp(ExtractedFolder="") {
	Global romTable,dbName,mgEnabled,pauseEnabled,RLLog
	Global sevenZEnabled,sevenZDelTemp,sevenZCanceled,sevenZ1stRomPath,sevenZCleanUpTriggered
	sevenZDeleteFolder := If ExtractedFolder = "" ? sevenZ1stRomPath : ExtractedFolder
	If (sevenZEnabled = "true" && !sevenZCleanUpTriggered && (sevenZDelTemp = "true" or sevenZCanceled))	; if user wants to delete temp files or user canceled a 7z extraction
