...
::::::::::::::::: INICIO-Ajustando la ruta de configuracion de retroshur:::::::::::::::::::::::::::::::::::
     %FNR_APP%\fnr.exe --cl --dir "%HOME%\" --fileMask "*.cfg, *.config, *.ini, *.yml" --includeSubDirectories --useRegEx --find "[abcdefghijklmnopqrstuvwxyz]:(.*?)[/\\]RETROSHUR-FRONTEND[/\\]" --replace "%HOME%RETROSHUR-FRONTEND\\" --silent
...
call "RETROSHUR-FULLSCREEN.cmd" /min && exit && GOTO END
